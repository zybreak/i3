...
export class CommandsApplier : public BaseCommandsApplier {
   public:
     ...
     *
     */
    void criteria_init(criteria_state *criteria_state, CommandResultIR &cmd_output) override;
     ...
     *
     */
    void criteria_add(criteria_state *criteria_state, CommandResultIR &cmd_output, const char *ctype, const char *cvalue) override;
