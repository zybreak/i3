...
public:
  ...
  enum {
    ...
    RuleCommand_kill = 34, RuleCommand_fullscreen = 35, RuleCommand_debuglog = 36, 
    RuleCommand_border = 37, RuleCommand_layout = 38, RuleCommand_append_layout = 39, 
    RuleCommand_workspace = 40, RuleCommand_focus = 41, RuleCommand_split = 42, 
    RuleCommand_floating = 43, RuleCommand_mode = 44, RuleCommand_scratchpad = 45, 
    RuleCriteria = 46, RuleCriterion = 47, RuleValue_criterion = 48
  };
