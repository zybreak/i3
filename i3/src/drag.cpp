...
static bool drain_drag_events(EV_P_ struct drag_x11_cb *dragloop) {
...
drag_result_t drag_pointer(Con *con, const xcb_button_press_event_t *event,
                           ...
                           const void *extra) {
    xcb_cursor_t xcursor = cursor ? global.x->xcursor_get_cursor(static_cast<xcursor_cursor_t>(cursor)) : XCB_NONE;
