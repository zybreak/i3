 ...
 *
 */
    void move_con_to_workspace_name(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *name,
 ...
 *
 */
    void move_con_to_workspace_number(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *which,
                                      const char *no_auto_back_and_forth);
 ...
 *
 */
    void resize_set(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, long cwidth, const char *mode_width,
 ...
 *
 */
    void resize(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *way, const char *direction,
 ...
 */
    void
    border(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *border_style_str, long border_width);
 ...
 *
 */
    void append_layout(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *path);
 ...
 *
 */
    void workspace_number(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *which,
                          const char *no_auto_back_and_forth);
 ...
 *
 */
    void workspace_name(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *name,
                        const char *no_auto_back_and_forth);
 ...
 */
    void
    move_con_to_output(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *name, bool move_workspace);
 ...
 *
 */
    void focus_direction(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *direction);

/**
 * Implementation of 'focus next|prev sibling'
 *
 */
    void focus_sibling(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *direction);
 ...
 *
 */
    void fullscreen(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *action,
 ...
 */
    void
    move_direction(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *direction_str, long amount,
                   const char *mode);
 ...
 *
 */
    void move_window_to_position(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, long x, const char *mode_x,
 ...
 *
 */
    void rename_workspace(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *old_name,
                          const char *new_name);
 ...
 *
 */
    void bar_hidden_state(struct criteria_state &criteria_state, struct CommandResultIR &cmd_output, const char *bar_hidden_state,
                          const char *bar_id);
