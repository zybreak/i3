...
void Tree<T, tree_node_allocator>::head_initialise_()
{
    ...
    std::allocator_traits<decltype(alloc_)>::construct(alloc_, head, TreeNode<T>());
    std::allocator_traits<decltype(alloc_)>::construct(alloc_, feet, TreeNode<T>());
