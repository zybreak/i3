 ...
 *
 */
void ApplicationLauncher::startup_monitor_event(SnMonitorEvent *event) {
 ...
 *
 */
std::optional<std::string> ApplicationLauncher::startup_workspace_for_window(i3Window *cwindow, xcb_get_property_reply_t *startup_id_reply) {
