...
def parser_calls(cmd):
    def f(command):
        process = subprocess.Popen([cmd + "/test.config_parser"], stdin=subprocess.PIPE, stderr=subprocess.PIPE,
...
def test_mode_bindings_ok(parser_calls):
    config = """
mode "meh" {
...
################################################################################
def test_exec_okay(parser_calls):
    config = """
exec geeqie
...
# for_window
################################################################################
def test_for_window_okay(parser_calls):
    config = """
...
def test_for_window_errors_okay(parser_calls):
    config = """
...
# assign
################################################################################
def test_for_window_okay2(parser_calls):
    config = """
...
################################################################################
def test_floating_minimum_size_ok(parser_calls):
    config = """
...
################################################################################
def test_popup_during_fullscreen_ok(parser_calls):
    config = """
...
# floating_modifier
################################################################################
def test_floating_modifier_ok(parser_calls):
    config = """
...
# default_orientation
################################################################################
def test_default_orientation_ok(parser_calls):
    config = """
...
# workspace_layout
################################################################################
def test_workspace_layout_ok(parser_calls):
    config = """
...
################################################################################
def test_workspace_assignment_ok(parser_calls):
    config = """
...
# new_window
################################################################################
def test_new_window_ok(parser_calls):
    config = """
new_window 1pixel
new_window normal
new_window none
...
# hide_edge_borders
################################################################################
def test_hide_edge_borders_ok(parser_calls):
    config = """
...
# focus_follows_mouse
################################################################################
def test_focus_follows_mouse_ok(parser_calls):
    config = """
...
# mouse_warping
################################################################################
def test_mouse_warping_ok(parser_calls):
    config = """
...
# workspace
################################################################################
def test_workspace_ok(parser_calls):
    config = """
workspace 3 output VGA-1
...
def test_ipc_socket_ok(parser_calls):
    config = """
...
# colors
################################################################################
def test_colors_ok(parser_calls):
    config = """
...
################################################################################
def test_errors_dont_harm_subsequent_statements(parser_calls):
    config = """
...
def test_errors_dont_harm_subsequent_statements2(parser_calls):
    config = """
...
################################################################################
def test_semicolon_does_not_end_a_comment_line(parser_calls):
    config = """
...
################################################################################
def test_error_message_2_2_context_ok(parser_calls):
    config = """
# i3 config file (v4)
...
################################################################################
def test_error_message_0_0_context_ok(parser_calls):
    config = """
unknown qux
"""
...
################################################################################
def test_error_message_1_0_context_ok(parser_calls):
    config = """
# context before
unknown qux
"""
...
################################################################################
def test_error_message_0_1_context_ok(parser_calls):
    config = """
unknown qux
# context after
"""
...
################################################################################
def test_error_message_0_2_context_ok(parser_calls):
    config = """
unknown qux
# context after
# context 2 after
...
################################################################################
def test_error_message_mode_block_ok(parser_calls):
    config = """
mode "yo" {
...
################################################################################
def test_error_message_bar_block_ok(parser_calls):
    config = """
bar {
    output LVDS-1
    unknown qux
