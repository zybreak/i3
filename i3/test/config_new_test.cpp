...
TEST(ConfigNewTest, test_exec_okay) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_for_window_okay) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_for_window_errors_okay) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_for_window_okay2) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_floating_minimum_size_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_popup_during_fullscreen_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_floating_modifier_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_default_orientation_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_workspace_layout_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_workspace_assignment_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_new_window_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_hide_edge_borders_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_focus_follows_mouse_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_mouse_warping_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_force_display_urgency_hint_300) {
    using namespace std::literals;
...
TEST(ConfigNewTest, test_workspace_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_ipc_socket_ok) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
    std::istringstream in{R""""(
ipc_socket "/tmp/i3.sock"
...
TEST(ConfigNewTest, test_colors_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_errors_dont_harm_subsequent_statements) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_errors_dont_harm_subsequent_statements2) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_semicolon_does_not_end_a_comment_line) {
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
    MockedResourceDatabase resourceDatabase{};
...
TEST(ConfigNewTest, test_error_message_2_2_context_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_error_message_0_0_context_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_error_message_1_0_context_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_error_message_0_1_context_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_error_message_0_2_context_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_error_message_mode_block_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
...
TEST(ConfigNewTest, test_error_message_bar_block_ok) {
    GTEST_SKIP();
    std::stringbuf output;
    std::ostream out{&output};
    ConfigApplierAdapter applier{out};
