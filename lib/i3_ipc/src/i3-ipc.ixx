 ...
 *
 */
export int ipc_connect(const std::string_view &socket_path);
 ...
 *
 */
export int ipc_send_message(int sockfd, const uint32_t message_size,
 ...
 *
 */
export int ipc_recv_message(int sockfd, uint32_t *message_type,
