...
static void got_output_reply(char *reply) {
    ...
    if (!config.disable_ws) {
        i3_send_msg(I3_IPC_MESSAGE_TYPE_GET_WORKSPACES, nullptr);
    }
...
static void got_bar_config(char *reply) {
    ...
    i3_send_msg(I3_IPC_MESSAGE_TYPE_GET_OUTPUTS, nullptr);
...
handler_t reply_handlers[] = {
    ...
    nullptr,                 /* I3_IPC_REPLY_TYPE_TREE */
    nullptr,                 /* I3_IPC_REPLY_TYPE_MARKS */
    &got_bar_config,      /* I3_IPC_REPLY_TYPE_BAR_CONFIG */
    nullptr,                 /* I3_IPC_REPLY_TYPE_VERSION */
    nullptr,                 /* I3_IPC_REPLY_TYPE_BINDING_MODES */
    nullptr,                 /* I3_IPC_REPLY_TYPE_CONFIG */
    nullptr,                 /* I3_IPC_REPLY_TYPE_TICK */
    nullptr,                 /* I3_IPC_REPLY_TYPE_SYNC */
};
...
static bool strings_differ(char *a, char *b) {
    const bool a_null = (a == nullptr);
    const bool b_null = (b == nullptr);
    if (a_null != b_null) {
        return true;
    }
    return strcmp(a, b) != 0;
...
static void got_data(struct ev_loop *loop, ev_io *watcher, int events) {
    ...
    char *header = (char*)smalloc(header_len);
     ...
     * of the message */
    char *buffer = (char*)smalloc(size + 1);
    rec = 0;
...
int i3_send_msg(uint32_t type, const char *payload) {
    ...
    char *buffer = (char*)smalloc(to_write);
    char *walk = buffer;
...
void init_connection(const char *socket_path) {
    ...
    i3_connection = (ev_io*)smalloc(sizeof(ev_io));
